...
return [
    ...
    'notification' => [
        ...
        'not_owner' => '无权删除此通知',
        'broadcast_readonly' => '共享广播不支持单用户修改已读状态',
        'broadcast_delete' => '共享广播不能由单个接收用户删除',
        'type_system' => '系统',
        'type_notice' => '通知',
        'type_message' => '消息',
        'type_todo' => '待办',
    ...
    'module' => [
        ...
        'disabled' => '禁用成功',
        'disable_failed' => '禁用失败',
        'logo_not_configured' => '模块未配置 Logo',
        'logo_not_found' => '模块 Logo 文件不存在',
    ],
    'system' => [
    ...
    'permission' => [
        ...
        'cannot_parent_self' => '不能将自己设为父级权限',
    ...
    'role' => [
        'cannot_delete_system' => '不能删除系统内置角色',
        'filter_all' => '全部',
    ],
    'menu' => [
        'login' => '登 录',
        ...
        'resource_name' => '菜单',
        'cannot_parent_self' => '不能将自己设为父级菜单',
    ...
    'placeholder' => [
        ...
        'title' => '请输入菜单标题',
        'path' => '请输入路由路径',
        'path_example' => '如：/system/user',
        'icon' => '请输入图标名称',
        'icon_example' => '如：carbon:user',
        'redirect' => '请输入重定向路径',
        'href' => '请输入外部链接',
        ...
        'sort' => '数字越小越靠前',
        'description' => '请输入描述',
        'role_description' => '请输入角色描述',
        'permission_description' => '请输入权限描述',
        'remark' => '请输入备注',
        ...
        'target_users' => '请选择接收用户，留空则发送给全部用户',
    ...
    'confirm' => [
        ...
        'delete_user_template' => '确定要删除用户 {{ slotData.row.username || slotData.row.nickname || slotData.row.id }} 吗？',
    ...
    'home' => [
        ...
        'revenue' => '收入',
        'system_started' => '系统启动',
        'system_started_content' => 'Lartrix 后台服务已正常启动',
        'user_login' => '用户登录',
        'admin_logged_in' => '管理员已登录系统',
        'visit_trend' => '访问趋势',
        'sales_stats' => '销售统计',
        'visit_count' => '访问量',
        'unique_users' => '独立用户',
        ...
        'api_key_copied' => 'API Key 已复制',
        'copy_failed' => '复制失败',
        'verified_copy' => '验证复制',
        'copy_success' => '复制成功',
        'nothing_to_copy' => '没有可复制内容',
    ],
    'validation' => [
